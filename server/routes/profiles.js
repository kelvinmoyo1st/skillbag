                                                                                                                                                              ...
                                                                                                                                                              [req.params.id]
                                                                                                                                                                      ...
                                                                                                                                                                      res.json(result.rows);
                                                                                                                                                                            ...
                                                                                                                                                                            next(err);
                                                                                                                                                                              ...
                                                                                                                                                                              // Create a reminder for a profile
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          if (profile.rows.length === 0) return res.status(404).json({ error: 'profile not found' });
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              const result = await pool.query(
                                                                                                                                                                                                                    'INSERT INTO reminders (profile_id, message, remind_at) VALUES ($1, $2, $3) RETURNING *',
                                                                                                                                                                                                                          [req.params.id, message, remind_at]
                                                                                                                                                                                                                              );
                                                                                                                                                                                                                                  res.status(201).json(result.rows[0]);
                                                                                                                                                                                                                                    } catch (err) {
                                                                                                                                                                                                                                        next(err);
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          // Get reminders that are due for a profile
                                                                                                                                                                                                                                          router.get('/:id/reminders/due', async (req, res, next) => {
                                                                                                                                                                                                                                            try {
                                                                                                                                                                                                                                                const result = await pool.query(
                                                                                                                                                                                                                                                      'SELECT * FROM reminders WHERE profile_id = $1 AND remind_at <= NOW() AND sent = FALSE ORDER BY remind_at ASC',
                                                                                                                                                                                                                                                            [req.params.id]
                                                                                                                                                                                                                                                                );
                                                                                                                                                                                                                                                                    res.json(result.rows);
                                                                                                                                                                                                                                                                      } catch (err) {
